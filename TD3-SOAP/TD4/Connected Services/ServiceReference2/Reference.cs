...
namespace ServiceReference2
{
    ...
    public interface IMathsOperations
    {
        ...
        System.Threading.Tasks.Task<int> AddAsync(int op1, int op2);
        ...
        System.Threading.Tasks.Task<int> MultiplyAsync(int op1, int op2);
        ...
        System.Threading.Tasks.Task<int> SubstractAsync(int op1, int op2);
    ...
    public partial class MathsOperationsClient : System.ServiceModel.ClientBase<ServiceReference2.IMathsOperations>, ServiceReference2.IMathsOperations
    {
        ...
        public System.Threading.Tasks.Task<int> AddAsync(int op1, int op2)
        {
            return base.Channel.AddAsync(op1, op2);
        }
        
        public System.Threading.Tasks.Task<int> MultiplyAsync(int op1, int op2)
        {
            return base.Channel.MultiplyAsync(op1, op2);
        }
        
        public System.Threading.Tasks.Task<int> SubstractAsync(int op1, int op2)
        {
            return base.Channel.SubstractAsync(op1, op2);
        }
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IMathsOperations))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:8733/Design_Time_Addresses/WcfServiceLibrary1/MathsOperations/");
            }
            throw new System.InvalidOperationException(string.Format("Le point de terminaison nommé \'{0}\' est introuvable.", endpointConfiguration));
        }
